...
--end
--end, 1200, "YBTL" )
--weatherwidget:buttons(awful.util.table.join(awful.button({}, 3, function () awful.util.spawn ( browser .. " http://www.weatherzone.com.au/world/north-america/united-states/nashville") end)))
